...
| **Cybersecurity Labs** | ![C](https://img.shields.io/badge/C-A8B9CC?style=flat-square&logo=c&logoColor=white) ![Linux](https://img.shields.io/badge/Linux-FCC624?style=flat-square&logo=linux&logoColor=black) | University coursework — educational demonstrations of buffer overflow, Kaminsky DNS poisoning, XSS, HTTP response splitting, and blind SQL injection in an isolated lab environment. | [📁 Code](https://github.com/yarintsukrun/cybersecurity-labs) | — |
